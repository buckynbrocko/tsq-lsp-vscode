# vscode-tree-sitter-dev README

This is the README for your extension "vscode-tree-sitter-dev". After writing up a brief description, we recommend including the following sections.
